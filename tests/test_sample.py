...
class SampleBarcodeFunctionTests(unittest.TestCase):
    ...
    def test_check_names(self):
        self.assertRaises(ValueError, check_sample_names, ["S2", "S2"])
        self.assertRaises(ValueError, check_sample_names, ["unassigned"])

    def test_check_barcodes(self):
        self.assertRaises(ValueError, check_barcodes, ["AGCR"])
        self.assertRaises(ValueError, check_barcodes, ["AA", "AA"])
